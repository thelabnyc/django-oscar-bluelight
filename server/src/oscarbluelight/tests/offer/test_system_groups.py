...
class OfferGroupModelTest(TestCase):
    ...
    def test_register_system_offer_group(self):
        ...
        my_system_group = register_system_offer_group(
            "my-system-group", default_name="My System Group"
        )
    ...
    def test_register_system_offer_group_with_existing_groups(self):
        ...
        OfferGroup.objects.create(name="Low Priority Offers", priority=25)
        OfferGroup.objects.create(name="Medium Priority Offers", priority=500)
        OfferGroup.objects.create(name="High Priority Offers", priority=1500)
    ...
    def test_receivers(self):
        ...
        group1 = OfferGroup.objects.create(
            slug="group-1", name="Group 1", priority=1, is_system_group=True
        )
        group2 = OfferGroup.objects.create(
            slug="group-2", name="Group 2", priority=2, is_system_group=True
        )
        ...
        pre_offer_group_apply.send(
            sender=Applicator, basket=None, group=group1, offers=[]
        )

        # Ensure correct handler was called
        handler1_pre.assert_called_once_with(
            Applicator,
            basket=None,
            group=group1,
            offers=[],
        ...
        handler1_post.assert_called_once_with(
            Applicator,
            basket=None,
            group=group1,
            offers=[],
        ...
        # Send group2 pre
        pre_offer_group_apply.send(
            sender=Applicator, basket=None, group=group2, offers=[]
        )
        ...
        handler2_pre.assert_called_once_with(
            Applicator,
            basket=None,
            group=group2,
            offers=[],
        ...
        handler2_post.assert_called_once_with(
            Applicator,
            basket=None,
            group=group2,
            offers=[],
