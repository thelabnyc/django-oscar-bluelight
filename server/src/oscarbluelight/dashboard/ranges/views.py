...
RangeExcludedProductsUpdateForm = get_class('ranges_dashboard.forms', 'RangeExcludedProductsUpdateForm')
...
class RangePriceListView(UpdateView):
    ...
    def form_valid(self, form):
        ...
        return self.render_to_response(self.get_context_data(form=form, preview=True, changes=changes))
